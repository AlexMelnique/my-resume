...
const modalRequestModal = document.querySelector('#modal-request');
...
callbackForm.addEventListener('submit', function(event) {
    ...
    modalRequestModal.classList.add('modal-active');

    setTimeout(function() {
        modalRequestModal.classList.remove('modal-active');
    }, 1500);
});
